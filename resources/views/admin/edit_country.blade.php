    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row m-2 mb-0">
                <div class="col-sm-6">
                    <h2 class="m-0 text-dark leave-main-heading bottom-margin mt-2 mb-0">Edit Country & Location</h2>
            ...
            <div class="col-12">
                <div style="box-shadow: none !important;" class="card card-primary application-leave">
                    <form style="box-shadow: 0px 0px 16px -3px rgba(0, 0, 0, 0.25);border-radius: 15px !important;" method="POST" action="{{route('updatecountry')}}" role="form" id="addForm">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <label for="password">country :</label>
                                    <input type="text" class="form-control" id="password" name="new_country" value="{{$country->country}}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="address" name="address" >{{$country->address}}</textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="password" name="tel" value="{{$country->tel}}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="password" name="fax" value="{{$country->fax}}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="password" name="url" value="{{$country->url}}">
