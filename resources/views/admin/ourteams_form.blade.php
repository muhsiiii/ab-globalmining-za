        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                <div style="box-shadow: none !important;" class="card card-primary application-leave">
                    <form style="box-shadow: 0px 0px 16px -3px rgba(0, 0, 0, 0.25);border-radius: 15px !important;" method="POST" action="{{route('ourteams.save')}}" role="form" id="addForm" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="password" name="education" placeholder="Enter Education">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="password" name="position" placeholder="Enter Job Position">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select style="width: 100%;padding: 8px;    border: 1px solid #ced4da;border-radius:6px;" id="job" name="categories">
                                        <option value="" selected disabled>Select Job Disipline</option>
                                        <option value="executive teams">Executive team</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="password" name="url" placeholder="Enter Job Position">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="address" name="description" placeholder="Enter Description..." style="height: 125px;width: 782px;"></textarea>
